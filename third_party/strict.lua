...
function handler(m,n,v)
	...
	if (v~=nil) then g.print('Strict warning: invalid assignment to '..n..m..g.debug.traceback('', 3))
	else g.print('Strict warning: ' .. n..' not declared'..m..g.debug.traceback('', 3)) end
end
